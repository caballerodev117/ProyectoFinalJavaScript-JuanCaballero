...
// Agrega la info de confirmación en la columna derecha
    ...
    infoPersonal.innerHTML = `
      ...
      <div class="informacion-personal__locacion">${carritoDetallesForm[5].value} ${carritoDetallesForm[6].value} - ${carritoDetallesForm[7].value}</div>
